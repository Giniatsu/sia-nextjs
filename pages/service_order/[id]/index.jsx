...
const ServiceOrderDetails = () => {
  ...
  const handleAddEntry = () => {
    router.push(`/service_order/${id}/entry`);
  }
  ...
  const handleSaveEntry = (index) => {
    ...
    fetch(`/service_order_entries/${entry.id}/`, {
      method: 'PUT',
      headers: {
        'Authorization': `Bearer ${tokens?.access}`,
        'Content-Type': 'application/json',
            ...
            <div className="grid grid-cols-6 m-5">
              ...
              <div className="col-span-3 mt-3">
                <div className="grid grid-cols-2 gap-x-8 gap-y-4">
                  ...
                  <p className="">{order?.service_date}</p>
                  <h4 className="">TECHNICIAN</h4>
                  <p className="">{technician?.tech_name}</p>
                </div>
              </div>
